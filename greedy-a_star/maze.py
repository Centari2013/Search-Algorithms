...
class Maze(object):
    ...
    def __init__(self, num_rows, num_cols, numPzLocs = 1, id=0):
        ...
        self.orig_prize_coor_list = self.prize_coor_list.copy()
    ...
    def ClearSolution(self):
        ...
        self.prize_coor_list = self.orig_prize_coor_list.copy()
